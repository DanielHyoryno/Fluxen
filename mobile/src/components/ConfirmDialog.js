  ...
  return (
    <Modal transparent visible={visible} animationType="fade" onRequestClose={onCancel}>
      ...
      >
        ...
        >
          <Text style={{ color: "#1a3047", fontWeight: "700", fontSize: 18, textAlign: "center" }}>{title}</Text>
          <Text style={{ color: "#4f6982", marginTop: 8, textAlign: "center", lineHeight: 21 }}>{message}</Text>
