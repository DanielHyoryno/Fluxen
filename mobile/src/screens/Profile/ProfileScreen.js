    ...
    <Animated.View style={[styles.page, animatedStyle]}>
      ...
      <View style={styles.card}>
        ...
        <View style={styles.languageRow}>
          ...
          >
            <Text style={[styles.languageButtonText, locale === "en" && styles.languageButtonTextActive]}>{messages.profile.english}</Text>
          </Pressable>
          <Pressable
            style={[styles.languageButton, locale === "id" && styles.languageButtonActive]}
            onPress={() => setLocale("id")}
          >
            <Text style={[styles.languageButtonText, locale === "id" && styles.languageButtonTextActive]}>{messages.profile.indonesian}</Text>
          </Pressable>
        </View>
      </View>
